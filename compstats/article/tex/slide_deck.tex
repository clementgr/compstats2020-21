...
This \textit{seemed} conclusion is incorrect\\
...
\eit
-> Jacobian calculation (and metric calculation) were very slow. We were not able to reproduce all of the results of the paper, as it would have needed a lot of jacobian calculations
\end{frame}
...
\begin{frame}
	...
	\includegraphics[width=5cm]{../fig/euclidean_walk.png}
	\includegraphics[width=5cm]{../fig/riemannian_walk.png}
\end{frame}
